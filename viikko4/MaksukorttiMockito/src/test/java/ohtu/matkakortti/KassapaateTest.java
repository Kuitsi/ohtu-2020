...
public class KassapaateTest {
    ...
    @Test
    public void kortilleLadataanJosRahaaOn() {
        int ladattava = 15;
        kassa.lataa(kortti, ladattava);
        verify(kortti, times(1)).lataa(ladattava);
    }

    @Test
    public void kortiltaEiVelotetaJosLatausSummaNegatiivinen() {
